...
test.describe('Accessibility Tests', () => {
	...
	test('tools page should not have accessibility violations', async ({ page }) => {
	...
	test('status dashboard should have proper headings hierarchy', async ({ page }) => {
		await page.goto('/Awesome-IIUM/dashboard/');
		await page.waitForLoadState('networkidle');
	...
	test('forms should have proper labels', async ({ page }) => {
		...
		const inputs = page.locator('.gpa-calculator input, .gpa-calculator select');
